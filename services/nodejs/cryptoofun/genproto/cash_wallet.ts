...
export class AskCashBalanceRequest extends pb_1.Message {
  ...
  static fromObject(data: { user_id?: string }): AskCashBalanceRequest {
  ...
  static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AskCashBalanceRequest {
    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
      message = new AskCashBalanceRequest();
...
export class AskCashBalanceResponse extends pb_1.Message {
  ...
  static fromObject(data: { user_id?: string; balance?: number }): AskCashBalanceResponse {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.user_id.length) writer.writeString(1, this.user_id);
    if (this.balance != 0) writer.writeDouble(2, this.balance);
    if (!w) return writer.getResultBuffer();
  }
  static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AskCashBalanceResponse {
    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
      message = new AskCashBalanceResponse();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class ModifyCashBalanceRequest extends pb_1.Message {
  ...
  static fromObject(data: { user_id?: string; delta?: number }): ModifyCashBalanceRequest {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.user_id.length) writer.writeString(1, this.user_id);
    if (this.delta != 0) writer.writeDouble(2, this.delta);
    if (!w) return writer.getResultBuffer();
  }
  static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ModifyCashBalanceRequest {
    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
      message = new ModifyCashBalanceRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class ModifyCashBalanceResponse extends pb_1.Message {
  ...
  static fromObject(data: { user_id?: string; balance_after?: number }): ModifyCashBalanceResponse {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.user_id.length) writer.writeString(1, this.user_id);
    if (this.balance_after != 0) writer.writeDouble(2, this.balance_after);
    if (!w) return writer.getResultBuffer();
  }
  static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ModifyCashBalanceResponse {
    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
      message = new ModifyCashBalanceResponse();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class AskTopBalancesDescendingRequest extends pb_1.Message {
  ...
  static fromObject(data: { skip?: number; take?: number }): AskTopBalancesDescendingRequest {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.skip != 0) writer.writeUint32(1, this.skip);
    if (this.take != 0) writer.writeUint32(2, this.take);
    if (!w) return writer.getResultBuffer();
  }
  static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AskTopBalancesDescendingRequest {
    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
      message = new AskTopBalancesDescendingRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class AskTopBalancesDescendingResponse extends pb_1.Message {
  ...
  static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AskTopBalancesDescendingResponse {
    const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
      message = new AskTopBalancesDescendingResponse();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
          reader.readMessage(message.balances, () =>
            pb_1.Message.addToRepeatedWrapperField(
              message,
              1,
              BalanceItem.deserialize(reader),
              BalanceItem
            )
          );
          break;
...
export class BalanceItem extends pb_1.Message {
  ...
  static fromObject(data: { user_id?: string; balance?: number }): BalanceItem {
...
export abstract class UnimplementedCashWalletServiceService {
  static definition = {
    ...
    ModifyCashBalance: {
      ...
      requestDeserialize: (bytes: Buffer) =>
        ModifyCashBalanceRequest.deserialize(new Uint8Array(bytes)),
      responseSerialize: (message: ModifyCashBalanceResponse) => Buffer.from(message.serialize()),
      responseDeserialize: (bytes: Buffer) =>
        ModifyCashBalanceResponse.deserialize(new Uint8Array(bytes)),
    },
    AskTopBalancesDescending: {
      path: '/CashWalletService/AskTopBalancesDescending',
      requestStream: false,
      responseStream: false,
      requestSerialize: (message: AskTopBalancesDescendingRequest) =>
        Buffer.from(message.serialize()),
      requestDeserialize: (bytes: Buffer) =>
        AskTopBalancesDescendingRequest.deserialize(new Uint8Array(bytes)),
      responseSerialize: (message: AskTopBalancesDescendingResponse) =>
        Buffer.from(message.serialize()),
      responseDeserialize: (bytes: Buffer) =>
        AskTopBalancesDescendingResponse.deserialize(new Uint8Array(bytes)),
    },
  };
  [method: string]: grpc_1.UntypedHandleCall;
  abstract AskCashBalance(
    call: grpc_1.ServerUnaryCall<AskCashBalanceRequest, AskCashBalanceResponse>,
    callback: grpc_1.sendUnaryData<AskCashBalanceResponse>
  ): void;
  abstract ModifyCashBalance(
    call: grpc_1.ServerUnaryCall<ModifyCashBalanceRequest, ModifyCashBalanceResponse>,
    callback: grpc_1.sendUnaryData<ModifyCashBalanceResponse>
  ): void;
  abstract AskTopBalancesDescending(
    call: grpc_1.ServerUnaryCall<AskTopBalancesDescendingRequest, AskTopBalancesDescendingResponse>,
    callback: grpc_1.sendUnaryData<AskTopBalancesDescendingResponse>
  ): void;
}
export class CashWalletServiceClient extends grpc_1.makeGenericClientConstructor(
  UnimplementedCashWalletServiceService.definition,
  'CashWalletService',
  {}
) {
  constructor(
  ...
  AskCashBalance: GrpcUnaryServiceInterface<AskCashBalanceRequest, AskCashBalanceResponse> = (
    message: AskCashBalanceRequest,
    metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<AskCashBalanceResponse>,
    options?: grpc_1.CallOptions | grpc_1.requestCallback<AskCashBalanceResponse>,
    callback?: grpc_1.requestCallback<AskCashBalanceResponse>
  ): grpc_1.ClientUnaryCall => {
    return super.AskCashBalance(message, metadata, options, callback);
  };
  ModifyCashBalance: GrpcUnaryServiceInterface<
  ...
  > = (
    ...
    metadata:
      | grpc_1.Metadata
      | grpc_1.CallOptions
      | grpc_1.requestCallback<ModifyCashBalanceResponse>,
  ...
  AskTopBalancesDescending: GrpcUnaryServiceInterface<
  ...
  > = (
    ...
    metadata:
      | grpc_1.Metadata
      | grpc_1.CallOptions
      | grpc_1.requestCallback<AskTopBalancesDescendingResponse>,
    options?: grpc_1.CallOptions | grpc_1.requestCallback<AskTopBalancesDescendingResponse>,
    callback?: grpc_1.requestCallback<AskTopBalancesDescendingResponse>
  ): grpc_1.ClientUnaryCall => {
