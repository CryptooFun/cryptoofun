...
export class AskPortfolioRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AskPortfolioRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new AskPortfolioRequest();
...
export class AskPortfolioResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.portfolio.length)
            writer.writeRepeatedMessage(1, this.portfolio, (item: PortfolioItem) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AskPortfolioResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new AskPortfolioResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.portfolio, () => pb_1.Message.addToRepeatedWrapperField(message, 1, PortfolioItem.deserialize(reader), PortfolioItem));
                    break;
                default: reader.skipField();
            }
        }
...
export class PortfolioItem extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.cost != 0)
            writer.writeDouble(2, this.cost);
        if (this.amount != 0)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PortfolioItem {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PortfolioItem();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class ModifySingleTickerRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.cost != 0)
            writer.writeDouble(3, this.cost);
        if (this.amount != 0)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ModifySingleTickerRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ModifySingleTickerRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export class ModifySingleTickerResponse extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ModifySingleTickerResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ModifySingleTickerResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
...
export abstract class UnimplementedPortfolioServiceService {
    static definition = {
        ...
        ModifySingleTicker: {
            ...
            requestDeserialize: (bytes: Buffer) => ModifySingleTickerRequest.deserialize(new Uint8Array(bytes)),
            responseSerialize: (message: ModifySingleTickerResponse) => Buffer.from(message.serialize()),
            responseDeserialize: (bytes: Buffer) => ModifySingleTickerResponse.deserialize(new Uint8Array(bytes))
        }
    };
...
export class PortfolioServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedPortfolioServiceService.definition, "PortfolioService", {}) {
    ...
    AskPortfolio: GrpcUnaryServiceInterface<AskPortfolioRequest, AskPortfolioResponse> = (message: AskPortfolioRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<AskPortfolioResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<AskPortfolioResponse>, callback?: grpc_1.requestCallback<AskPortfolioResponse>): grpc_1.ClientUnaryCall => {
        return super.AskPortfolio(message, metadata, options, callback);
    };
    ModifySingleTicker: GrpcUnaryServiceInterface<ModifySingleTickerRequest, ModifySingleTickerResponse> = (message: ModifySingleTickerRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<ModifySingleTickerResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<ModifySingleTickerResponse>, callback?: grpc_1.requestCallback<ModifySingleTickerResponse>): grpc_1.ClientUnaryCall => {
